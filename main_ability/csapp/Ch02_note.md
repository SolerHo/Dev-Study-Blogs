...
![](./img/ch02_img/数字扩展和截断的基本规则总结.png)
...
![](./img/ch02_img/规格化的例子.png)

- 非规格化

![](./img/ch02_img/非规格化.png)

- 特殊值

![](./img/ch02_img/特殊值.png)

### 4.3 浮点数的运算

- 浮点数的加法

![](./img/ch02_img/浮点数加法.png)

- 浮点数的乘法

![](./img/ch02_img/浮点数乘法.png)

### 4.4 C语言中的浮点数

![](./img/ch02_img/C中的浮点数.png)

### 4.5 浮点数的总结

![](./img/ch02_img/浮点数的总结.png)